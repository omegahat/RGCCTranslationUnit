...
# cat("Defining classes for nativeC++ GCC nodes\n")
 ...
 setClass( 'GCC::Node::try_finally' , contains =  "OperandNode" )
  ...
  #Note: added manually.
 setClass( 'GCC::Node::init_expr' , contains =  "GCCNode" )
 setClass( 'GCC::Node::non_lvalue_expr' , contains =  "GCCNode" )
 setClass( 'GCC::Node::floor_div_expr' , contains =  "GCCNode" )
 setClass( 'GCC::Node::floor_mod_expr' , contains =  "GCCNode" )   
 setClass( 'GCC::Node::ceil_div_expr' , contains =  "GCCNode" )
 setClass( 'GCC::Node::ceil_mod_expr' , contains =  "GCCNode" )
 setClass( 'GCC::Node::round_div_expr' , contains =  "GCCNode" ) 
 setClass( 'GCC::Node::round_mod_expr' , contains =  "GCCNode" ) 
 setClass( 'GCC::Node::compound_stmt' , contains =  "GCCNode" )
 setClass( 'GCC::Node::scope_stmt' , contains =  "GCCNode" )
 setClass( 'GCC::Node::decl_stmt' , contains =  "GCCNode" )
 setClass( 'GCC::Node::label_stmt' , contains =  "GCCNode" )
 setClass( 'GCC::Node::goto_stmt' , contains =  "GCCNode" )
 setClass( 'GCC::Node::case_label' , contains =  "GCCNode" )
 setClass( 'GCC::Node::return_stmt' , contains =  "GCCNode" )   
...
setMethod('getNextNode', 'GCC::Node::using_decl' , function(node) node[['chan']])
...
setMethod('getNodeSource', 'GCC::Node::using_decl' , function(node) node[['source']])
